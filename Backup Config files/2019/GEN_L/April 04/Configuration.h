//April 04 MKS_GEN_L --added E3D v6 --added Bowden - park- m600 BLT3 acceleration - probe edges
...
#define STRING_CONFIG_H_AUTHOR "Rudy, Anet A8 settings" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bug 2 April 4"
...
//E3D v6
  #define DEFAULT_Kp 18.32 //20.65
  #define DEFAULT_Ki 1.73  //2.10
  #define DEFAULT_Kd 48.39 //50.76
...
//Anet A8 hardware.
  ...
  #define DEFAULT_bedKp 225.39
  #define DEFAULT_bedKi 39.30
  #define DEFAULT_bedKd 323.12 
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 241 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.32  // Z offset: -below +above  [the nozzle]
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 30), 30 }
