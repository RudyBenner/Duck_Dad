//February 20 MKS_GEN_L --added E3D v6
...
#define CUSTOM_MACHINE_NAME "Bug 2 Feb 15"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 215 } //{ 80, 80, 4000, 500 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.5   //-2.34 // Z offset: -below +above  [the nozzle]
