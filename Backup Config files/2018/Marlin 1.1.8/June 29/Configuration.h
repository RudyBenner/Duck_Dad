...
#define CUSTOM_MACHINE_NAME "1.1.8"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 510.25 //10.00
  #define  DEFAULT_bedKi 92.97 //.023
  #define  DEFAULT_bedKd 700.13 //305.4
...
/**
 * Default Settingstrue* These settings can be reset by M502
 *
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 8, 54 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { -15, 48, (Z_MIN_POS + 1)} 
  #define NOZZLE_CLEAN_END_POINT {-2, 78, (Z_MIN_POS + 1)}
