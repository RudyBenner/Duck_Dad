...
#define CUSTOM_MACHINE_NAME "Go_Go_Gadget"
...
#define PIDTEMP
#define BANG_MAX 192 //255     // Limits current to nozzle while in bang-bang mode; 255=full current
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 200 } //{ 80, 80, 4000, 500 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 8, 54 } //{ 300, 300, 5, 25 }
